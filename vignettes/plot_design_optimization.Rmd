...
```{r include=FALSE}
dir.data <- getwd()
download.file("https://www.dropbox.com/s/8a0hwh1xpqlprjc/RB.G.fixed.area.plot.html?dl=1",
...
```{r include=FALSE}
dir.data <- getwd()
download.file("https://www.dropbox.com/s/etriqgcmbahab7z/correlations.h.fixed.area.pearson.html?dl=1",
...
```{r include=FALSE}
dir.data <- getwd()
download.file("https://www.dropbox.com/s/e0wzq32ltjjeren/opt.correlations.fixed.area.pearson.html?dl=1",
              destfile = file.path(dir.data, "opt.correlations.fixed.area.pearson.html"),
              mode = "wb")
```

As an example, the heat map of the pearson correlation coefficient for fixed area plots and pearson measure is provided and can be seen when opening the link ([opt.correlations.fixed.area.pearson.html](opt.correlations.fixed.area.pearson.html)).
