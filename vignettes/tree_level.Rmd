...
The following figure shows the normalized point cloud which is used as example data below. The function `plot` from the [lidR](https://cran.r-project.org/web/packages/lidR/index.html) package is used to generate the figure. 
