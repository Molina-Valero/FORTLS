...
dir.data <- getwd()
dir.result <- getwd()
download.file("https://www.dropbox.com/s/9jrk455ciyy8p84/Galicia_single_scan_reduced.laz?dl=1",
              destfile = file.path(dir.data, "Galicia_single_scan.laz"),
              mode = "wb")
download.file("https://www.dropbox.com/s/u6hy83mgqwfdx8b/Galicia_multi_scan_reduced.laz?dl=1",
