...
Furthermore the scanning approach applied for data collection should be specified in **`scan.approach`** with `"single"` indicating the TLS single-scan approach and `"multi"` (set by default) indicating the TLS multi-scan and SLAM point clouds approach.
