...
fixed_radius_neighbors_with_ids <- function(mat, eps) {
    .Call(`_FORTLS_fixed_radius_neighbors_with_ids`, mat, eps)
}
...
geometric_features_point_parallel <- function(x, y, z, pto, dist, First_eigenvalue = TRUE, Second_eigenvalue = TRUE, Third_eigenvalue = TRUE, Sum_of_eigenvalues = TRUE, PCA_1 = TRUE, PCA_2 = TRUE, Anisotropy = TRUE, Planarity = TRUE, Linearity = TRUE, Surface_variation = TRUE, Normal_change_rate = TRUE, Verticality = TRUE, Number_of_points = TRUE, omnivariance = TRUE, eigenentropy = TRUE, surface_density = TRUE, volume_density = TRUE, solver_thresh = 50000L) {
    .Call(`_FORTLS_geometric_features_point_parallel`, x, y, z, pto, dist, First_eigenvalue, Second_eigenvalue, Third_eigenvalue, Sum_of_eigenvalues, PCA_1, PCA_2, Anisotropy, Planarity, Linearity, Surface_variation, Normal_change_rate, Verticality, Number_of_points, omnivariance, eigenentropy, surface_density, volume_density, solver_thresh)
}
